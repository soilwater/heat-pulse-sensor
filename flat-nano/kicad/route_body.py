"""Routes the body of hp_sensor.kicad_pcb (made by gen_pcb.py), pours the bottom GND plane, writes hp_sensor_routed.kicad_pcb.
...
BOARD, OUT = "hp_sensor.kicad_pcb", "hp_sensor_routed.kicad_pcb"
...
DIRECT_PAIRS = {"VREF": ("U1.59", "C13.1"), "5V_LDO": ("U3.3", "C2.1")}
CRITICAL_NETS = {"VREF", "XCIN", "XCOUT", "5V_LDO", "+5V"}
LOCAL_GROUNDS = {"C13.2", "U1.58"}
